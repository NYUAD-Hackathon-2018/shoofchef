...
def user_input():
    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument('-x', '--single_image', help='downloading a single image from URL', type=str,
                            required=False)
        parser.add_argument('-o', '--output_directory', help='download images in a specific directory', type=str,
                            required=False)
...
class googleimagesdownload:
    ...
    def build_url_parameters(self, arguments):
        ...
        params = {'color': [arguments['color'], {'red': 'ic:specific,isc:red', 'orange': 'ic:specific,isc:orange',
                  ...
                  'type': [arguments['type'], {'face': 'itp:face', 'photo': 'itp:photo', 'clip-art': 'itp:clip-art',
    ...
    def download_image(self, image_url, image_format, main_directory, dir_name, count, print_urls, socket_timeout,
        ...
        googleimagesdownload.img_URL = image_url
        if print_urls:
            print("Image URL: " + image_url)
        try:
            req = Request(image_url, headers={
    ...
    def _get_all_items(self, page, main_directory, dir_name, limit, arguments):
        ...
        while count < limit + 1:
            ...
            if object == "no_links":
                ...
                # download the images
                download_status, download_message, return_image_name = self.download_image(object['image_link'],
                                                                                           object['image_format'],
    ...
    def download(self, arguments):
            ...
            for sky in suffix_keywords:  # 1.for every suffix keywords
                ...
                while i < len(search_keyword):  # 2.for every main keyword
                    ...
                    url = self.build_search_url(search_term, params, arguments['url'], arguments['similar_images'],
                                                arguments['specific_site'])  # building main search url
                    ...
                    items, errorCount = self._get_all_items(raw_html, main_directory, dir_name, limit,
        ...
        return googleimagesdownload.img_URL
